 ...
 *   https://datatables.net/download/#bs5/dt-1.11.3/af-2.3.7/b-2.1.1/r-2.2.9/sb-1.3.0/sp-1.4.0/sl-1.3.4
 *
 * Included libraries:
 *   DataTables 1.11.3, AutoFill 2.3.7, Buttons 2.1.1, Responsive 2.2.9, SearchBuilder 1.3.0, SearchPanes 1.4.0, Select 1.3.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.11.3/af-2.3.7/b-2.1.1/r-2.2.9/sb-1.3.0/sp-1.4.0/sl-1.3.4",
