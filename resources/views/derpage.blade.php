...
<div class="col">
      ...
      <div class="card-body">
          ...
          @csrf
              <div class="form-group">
                  <div class="col-3 mb-4"> <p class="text-sm put"><b>Hutang</b></p>
                      <input type="number" name="hutang" class="form-control shadow-secondary border-2 input">
                      <label class="text-sm put"><b>Modal Sendiri</b></label>
                      <input type="number" name="modal_sendiri" class="form-control shadow-secondary border-2 input">
                  </div>
  ...
  <div class="col-lg-5 col-md-6 mb-md-0 mb-4">
    ...
    <div class="card-body">
        ...
        <div>
          <h2 class="mb-0 calceps" style="text-align: center;">1</h2>          
        </div>  
    </div>
  </div>
</div>
